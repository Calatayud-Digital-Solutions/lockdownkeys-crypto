...
> **Note:** Consumers that prefer the organization-scoped name can depend on
> `@calatayud-digital-solutions/lockdownkeys-crypto` via an npm alias to
> `@calaespi/crypto` until that scoped package is published with Trusted Publishing.
